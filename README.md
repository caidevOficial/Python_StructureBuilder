...
<table align='center'>
    ...
    <tbody>
        <tr>
        <td>
            <a href="https://youtu.be/F58NJgdSDuI" target="_blank">
                <center>
                    <img alt='Youtube Logo' src='./Media/YT_Logo.png?raw=true' width=350/>
                </center>
            </a>
        </td>
    </tr>
...
<table align='center'>
    <tbody>
        <tr>
            <td>
                <img alt="C_Sharp Logo" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/csharp/csharp-original.svg?raw=true" width="50px" height="50px" />
            </td>
            <td>
                <a href="https://github.com/CaidevOficial/CSharp_StructureBuilder/">C#</a>
            </td>
        </tr>
        <tr>
            <td>
